...
export default function EmptyState({ title, description }: EmptyStateProps) {
  return (
    <div className="flex flex-col items-center justify-center rounded-card border border-dashed border-brand-300 bg-white px-6 py-16 shadow-card">
      <svg
      ...
      <h3 className="text-sm font-medium text-brand-950">{title}</h3>
      {description && (
